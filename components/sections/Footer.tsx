...
// on a site whose whole pitch is transparency. (Write-ups used to be one of
// these; they now live on-site at /writeups, so the link is unconditional.)
  ...
  return (
    <footer className="relative flex flex-col items-center gap-4 px-6 py-24 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 font-body text-xs uppercase tracking-[0.2em] text-mist/50">
        <Link href="/writeups" className="transition hover:text-iris-cyan">
          {t('writeUps')}
        </Link>
        {GITHUB_URL && (
